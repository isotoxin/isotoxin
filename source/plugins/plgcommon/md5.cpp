...
void md5_c::done(unsigned char rslt[16])
{
...
const unsigned char *md5_c::result() const
{
    return (const unsigned char *)&m_context.state;
}
...
static void md5_process_message_block(unsigned long state[4], unsigned* x) {
